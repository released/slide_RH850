...
```mermaid
flowchart LR
    TOOL["CS+ / CC-RH / Debug Tool"] --> PROJECT["建立 RH850 專案"]
    PROJECT --> CONFIG["Clock / Pin / Component"]
    CONFIG --> PERIPHERAL["Timer / GPIO / Serial / ADC"]
    PERIPHERAL --> MEMORY["Code Flash / Data Flash"]
    MEMORY --> CAN["CAN / CAN FD"]
